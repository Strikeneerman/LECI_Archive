...
public class Circulo {
	...
	public Circulo(double raio, Ponto centro) {
		this.raio = raio;
		if(raio <= 0) {
			throw new IllegalArgumentException("Medida de raio invalida");
		}	
		this.centro = centro;
	}
	...
	public String toString() {
		return "Circulo de raio "+ this.raio + " ,centro " + this.centro.toString() + " ,perimetro " + this.peri_circ() +" e area " +this.area_circ();
	}
